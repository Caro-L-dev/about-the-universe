  ...
  <div class="home">
    <main class="container">
      <div class="card card-1">
        ...
        <p>
          Bienvenue sur
          <span class="text-secondary">ABOUT THE UNIVERSE</span>
          pour découvrir toutes nos découvertes à propos du monde qui nous entoure !
        </p>
        <a routerLink="/index-show-planets" class="btn mt-4">Découvrir</a>
      </div>
      <div class="card card-2">
        <h1 class="title text-secondary">Les chiffres</h1>
        <p>
          Nous nous efforcons à archiver toutes nos trouvailles pour vous les partager autant que possible !
        </p>
        ...
        <a href="#/rocket" class="btn mt-4 float-right">Participer à la prochaine mission</a>
      </div>
    </main>
  </div>
</template>
